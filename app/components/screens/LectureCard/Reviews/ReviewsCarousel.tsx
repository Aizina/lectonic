    ...
    <div className="bg-white py-16 px-6 font-gotham">
      <div className="mx-auto">
        <div className="flex justify-between items-center pb-10 py-12 px-44 ">
          <span className="text-[32px] font-bold font-azoft ">Что говорят о лекции</span>
          ...
          {reviews.map((review, i) => (
            ...
            >
              ...
              <div className="flex justify-between items-center gap-8 mt-2 border-b border-[#3F3F3F2B] pb-4">
                <span className="text-[16px] font-normal text-[#4860EF]">{review.company}</span>
                ...
                <Image 
                  ...
                  height={16} 
                />
                  <span className="text-[16px] font-normal text-[#2A2A2A]">{review.rating}</span>
                </div>
              </div>
              <p className="text-[16px] font-normal text-[#252525AD] mt-8">{review.review}</p>
            </div>
          ))}
        </div>
      </div>
